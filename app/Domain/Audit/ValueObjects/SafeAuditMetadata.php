    ...
    private function __construct(array $values)
    {
        if (count($values) > self::MAX_KEYS) {
            throw new InvalidArgumentException(
                'Audit metadata exceeds the bounded key limit.',
            );
        }
        ...
        foreach ($values as $key => $value) {
            if (
                ...
                throw new InvalidArgumentException(
                    'Audit metadata keys must use the safe identifier format.',
                );
            }
            ...
            if (preg_match(
                ...
                throw new InvalidArgumentException(
                    'Sensitive audit metadata keys are forbidden.',
                );
            }
            ...
            if (
                ...
                throw new InvalidArgumentException(
                    'Audit metadata values must be scalar or null.',
                );
            }
            ...
            if (
                ...
                throw new InvalidArgumentException(
                    'Audit metadata string value exceeds the safe limit.',
                );
            }
